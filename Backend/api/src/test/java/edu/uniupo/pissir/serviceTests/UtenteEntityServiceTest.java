...
public class UtenteEntityServiceTest {
    ...
    void setUp() {
        ...
        utenteModel = new UtenteModel("Jeremie", "Prince", "evrardngali12@gmail.com", "1994!", RuoloModel.AGRICOLTORE);
        utenteEntity = new UtenteEntity(UUID.randomUUID(), "Jeremie", "Prince", "evrardngali12@gmail.com", "1994!", RuoloEntity.AGRICOLTORE);
    ...
    public void shouldUpdateUtente() throws Throwable {
        ...
        //Given
        UtenteModel updateUtenteModelCandidate = new UtenteModel(UUID.randomUUID(), "Jeremie", "Prince", "jeremie@email.com", "1234", RuoloModel.AGRICOLTORE );
        ...
        UtenteModel updateUtente = utenteService.updateUtente( mockHttpSession, updateUtenteModelCandidate );
